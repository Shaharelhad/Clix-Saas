...
export interface OperationDefinition {
  ...
  editableBody?: boolean;           // Allow user to edit the body template (e.g., Notion property names)
  editableResponseMapping?: boolean; // Allow user to define their own response mappings
