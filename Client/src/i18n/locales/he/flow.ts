const flow = {
  ...
  nodeListDesc: "רשימת אפשרויות להקשה (למשל תאריכים)",
  ...
  // List node
  listHeader: "כותרת",
  listHeaderHint: "טקסט מודגש מעל ההודעה (אופציונלי)",
  listBody: "הודעה",
  listBodyHint: "טקסט שמופיע מעל כפתור הרשימה. ניתן להשתמש ב-{{שם_משתנה}} לערכים דינמיים.",
  listFooter: "כותרת תחתונה",
  listFooterHint: "טקסט קטן מתחת להודעה (אופציונלי)",
  listButtonText: "טקסט כפתור הרשימה",
  listButtonTextHint: "תווית הכפתור שפותח את הרשימה (למשל \"בחר תאריך\")",
  listDataVariable: "משתנה הנתונים",
  listDataVariableHint: "שם המשתנה שמכיל את המקטעים והשורות (מוגדר על ידי צומת API שקדם לו)",
  listRowIdVariable: "שמור rowId ב-",
  listRowIdVariableHint: "שם המשתנה לשמירת ה-id של השורה שנבחרה (למשל תאריך ISO)",
  listTitleVariable: "שמור כותרת ב- (אופציונלי)",
  listTitleVariableHint: "שם המשתנה לשמירת התווית של השורה שנבחרה",
  listSource: "מקור הנתונים",
  listSourceFromVariable: "ממשתנה",
  listSourceCalendarMonths: "לוח שנה — חודשים",
  listSourceCalendarDays: "לוח שנה — ימים",
  listMonthVariable: "משתנה החודש הנבחר",
  listMonthVariableHint: "שם המשתנה שהוגדר על ידי רשימת חודשים קודמת (למשל picked_month)",
  calendarMonthsHint: "מייצר חודשים אוטומטית מהיום ועד דצמבר של השנה הבאה. מתעדכן אוטומטית עם הזמן.",
  calendarDaysHint: "מייצר את הימים של החודש הנבחר אוטומטית, מקובצים לפי שבוע.",
  ...
  settingsCooldownMode: "מצב השהיה",
  settingsCooldownModeTemporary: "זמני",
  settingsCooldownModePermanent: "לצמיתות",
  ...
  settingsPostFlowPauseMode: "מצב השהיה",
  settingsPostFlowPauseModeTemporary: "זמני",
  settingsPostFlowPauseModePermanent: "לצמיתות",
