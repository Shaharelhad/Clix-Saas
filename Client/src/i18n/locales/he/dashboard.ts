const dashboard = {
  ...
  integrationNotionApiKey: "מפתח API של Notion",
  integrationNotionApiKeyHint: "מפתח אינטגרציה פנימית של Notion (מתחיל ב-ntn_ או secret_)",
  integrationNotionDatabaseId: "מזהה מסד נתונים (אופציונלי)",
  integrationNotionDatabaseIdHint: "מזהה ברירת מחדל — ניתן לדרוס בכל פעולה",
  ...
  integrationCustomHeaders: "כותרות מותאמות (Headers)",
  integrationCustomHeadersHint: "כותרות HTTP נוספות שישלחו עם כל בקשה",
  integrationAddHeader: "הוסף כותרת",
