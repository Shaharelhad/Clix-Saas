const createBot = {
  ...
  watchVideo: "צפה בסרטון הדרכה",
  mainSteps: "שלבים עיקריים:",
  connectStep1: "היכנס ל-green-api.com וצור חשבון",
  connectStep2: "צור Instance חדש",
  connectStep3: "העתק את ה-Instance ID ו-API Token",
  connectStep4: "חזור לכאן והדבק את הפרטים",
  gotIt: "הבנתי, בואו נמשיך",

  // Connect Section — GreenAPI Form
  greenApiTitle: "הזן את פרטי GreenAPI שלך",
  instanceIdLabel: "INSTANCE ID",
  instanceIdPlaceholder: "7105493385",
