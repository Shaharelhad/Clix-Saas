const createBot = {
  ...
  connectStep1: "Go to green-api.com and create an account",
  connectStep2: "Create a new Instance",
  connectStep3: "Copy the Instance ID and API Token",
  connectStep4: "Come back here and paste the details",
  gotIt: "Got it, let's continue",

  // Connect Section — GreenAPI Form
  greenApiTitle: "Enter Your GreenAPI Details",
