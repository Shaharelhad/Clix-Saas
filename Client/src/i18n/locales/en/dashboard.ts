const dashboard = {
  ...
  demoTestSettings: "Test Settings",
  demoTestPhone: "Phone:",
  ...
  integrationNotionApiKey: "Notion API Key",
  integrationNotionApiKeyHint: "Notion internal integration token (starts with ntn_ or secret_)",
  integrationNotionDatabaseId: "Database ID (optional)",
  integrationNotionDatabaseIdHint: "Default database ID — can be overridden per operation",
  ...
  integrationCustomHeaders: "Custom Headers",
  integrationCustomHeadersHint: "Additional HTTP headers sent with every request",
  integrationAddHeader: "Add header",
