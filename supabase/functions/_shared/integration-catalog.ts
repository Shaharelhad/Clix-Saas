...
export const INTEGRATION_CATALOG: ServiceDefinition[] = [
  ...
  },
  {
    ...
    operations: [
      ...
      {
        id: "queryDatabaseByFormulaString",
        labelKey: "notion_opQueryDatabaseByFormula",
        descriptionKey: "notion_opQueryDatabaseByFormulaDesc",
        method: "POST",
        endpointTemplate: "/v1/databases/{{databaseId}}/query",
        bodyTemplate: `{"filter":{"property":"{{filterProperty}}","formula":{"string":{"equals":"{{filterValue}}"}}}}`,
        editableResponseMapping: true,
        inputFields: [
          {
            id: "databaseId",
